							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									...
									<ul class="nav navbar-nav navbar-right menubar">
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle active" data-toggle="dropdown"><b>Sản phẩm</b><b class="caret"></b></a>
		...
		<div class ="container-fluid">
				...
				<div class="col-lg-12">
					<ol class="breadcrumb">
						<li><a href="index.php"><B>HOME</B></a>
							<li><a href="index.php"><B>Sản Phẩm</B></a></li>
							<li class="active"><B><?php
							$idloai = $_GET["id"];
							$query = "Select * from loaibanh where id =".$idloai."";
							$tmp = mysqli_query($conn,$query);
							$rowtmp = mysqli_fetch_array($tmp);	
							echo $rowtmp['tenloai']?></B></a></li>
						</li>
					</ol>
				</div>
			</div>
			...
			<div class="col-md-9">
				<div class="row">
					...
					$tmp = mysqli_query($conn,$query);
					$rowtmp = mysqli_fetch_array($tmp);
					echo '<h1>Sản phẩm '.$rowtmp['tenloai'].':</h1>';


					$query1 = "select * from banh where maloaibanh = ".$idloai."";
					...
					$query2 = "select * from banh where maloaibanh = ".$idloai." limit ".$x.",".$sosp;
